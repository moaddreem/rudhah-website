  ...
  return (
    <div className="min-h-screen" dir="rtl">
      ...
      <section className="py-10 md:py-16 bg-cream">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <span className="text-accent text-sm sm:text-base font-ui tracking-wider">من قائمتنا</span>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-5">
            {sweets.map((item, index) => (
              <div key={index} className="bg-bg rounded-xl p-4 sm:p-6 text-center shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1">
                ...
                <h3 className="text-base sm:text-lg font-bold text-primary">{item.name_ar}</h3>
                <p className="text-xs sm:text-sm text-muted mt-1">{item.name_en}</p>
      ...
      <section className="py-10 md:py-16">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <span className="text-accent text-sm sm:text-base font-ui tracking-wider">ماذا يقولون</span>
            <h2 className="text-2xl sm:text-2xl md:text-3xl font-mishafi font-bold text-primary mt-2">
              آراء العملاء
            </h2>
            <div className="w-16 h-1 bg-accent mx-auto mt-4 rounded-full"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {siteData.testimonials.map((testimonial, index) => (
              <div key={index} className="bg-cream rounded-xl p-6 relative">
                ...
                <p className="text-primary mb-4 leading-relaxed text-base">"{testimonial.text_ar}"</p>
                <p className="text-accent font-bold">— {testimonial.author_ar}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-10 md:py-16 bg-cream">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="text-center mb-10">
            <span className="text-accent text-sm font-ui tracking-wider">زورونا</span>
