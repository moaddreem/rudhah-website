      ...
      <section className="py-10 md:py-16 bg-cream">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="bg-bg rounded-xl p-8 shadow-sm max-w-2xl mx-auto">
            ...
            <p className="text-muted mb-6 text-lg">{siteData.location.context_ar}</p>
            
            <div className="bg-cream rounded-lg p-4 mb-6">
              <div className="flex justify-center gap-8 text-base">
                <div>
                  <p className="text-muted mb-1">{siteData.hours.weekdays.days_ar}</p>
                  <p className="text-primary font-bold text-lg">{siteData.hours.weekdays.open_ar} - {siteData.hours.weekdays.close_ar}</p>
                </div>
                <div className="w-px bg-muted/30"></div>
                <div>
                  <p className="text-muted mb-1">{siteData.hours.friday.day_ar}</p>
                  <p className="text-primary font-bold text-lg">{siteData.hours.friday.open_ar} - {siteData.hours.friday.close_ar}</p>
                </div>
              </div>
            </div>
