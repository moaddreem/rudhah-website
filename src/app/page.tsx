  ...
  return (
    <div className="min-h-screen" dir="rtl">
      ...
      <section className="py-10 md:py-16 bg-cream">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <span className="text-accent text-sm font-ui tracking-wider">من قائمتنا</span>
            ...
            {sweets.map((item, index) => (
              <div key={index} className="bg-bg rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1">
                ...
                <div className="mt-4 pt-4 border-t border-muted/20">
                  <p className="text-xl font-bold text-primary price" style={{ fontVariantNumeric: 'tabular-nums' }}><span dir="ltr" style={{ unicodeBidi: 'isolate' }}>{item.price}</span><Riyal /></p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-10 md:py-16">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <span className="text-accent text-sm font-ui tracking-wider">ماذا يقولون</span>
            <h2 className="text-2xl md:text-3xl font-mishafi font-bold text-primary mt-2">
              آراء العملاء
            </h2>
            <div className="w-16 h-1 bg-accent mx-auto mt-4 rounded-full"></div>
